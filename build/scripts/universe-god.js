...
exports.requireDecimal = requireDecimal;
...
},{"decimal.js":1}],11:[function(require,module,exports){
'use strict';

exports.__esModule = true;
exports.formatShort = exports.formatFull = exports.format = exports.Formatter = exports.Formats = undefined;

var _standardSuffixes = require('../static/standard-suffixes.json');

var _standardSuffixes2 = _interopRequireDefault(_standardSuffixes);

var _longScaleSuffixes = require('../static/long-scale-suffixes.json');
...
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } } // Can't comment a .json file, but the suffixes come from these pages:
...
var backends = {
  ...
  'decimal.js': {
    ...
    _requireDecimal: function _requireDecimal(config) {
      if (!(0, _decimal.requireDecimal)(config)) throw new Error('requireDecimal() failed');
      return new _decimal.requireDecimal(config)(0).constructor.clone(config);
    },
...
},{"../static/long-scale-suffixes.json":14,"../static/standard-suffixes.json":15,"./decimal":10}],12:[function(require,module,exports){
'use strict';
...
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
},{"./format":11,"./parse":13}],13:[function(require,module,exports){
'use strict';

exports.__esModule = true;
exports.Parser = exports.parse = undefined;
...
var suffixGroups = { standard: _standardSuffixes2.default }; // TODO longscale parsing. There's a duplicate
  ...
  'decimal.js': {
    parseInt: function parseInt(text, config) {
      if ('default' in config) {
        try {
          var val = (0, _decimal.requireDecimal)(config)(text).ceil();
          return this.isValid(val) ? val : config['default'];
        } catch (e) {
          return config.default;
        }
      }
      return (0, _decimal.requireDecimal)(config)(text).ceil();
    },
    isValid: function isValid(val) {
...
},{"../static/long-scale-suffixes.json":14,"../static/standard-suffixes.json":15,"./decimal.js":10}],14:[function(require,module,exports){
module.exports={
    "short": [
...
},{"./../util/favicon":23,"./../util/formatter":24,"./../util/logger":25,"./generatorTable":19,"./resourceTable":21,"jquery":3,"semantic-ui-accordion":6,"semantic-ui-dropdown":7,"semantic-ui-tab":8,"semantic-ui-transition":9}],18:[function(require,module,exports){
(function (process){
const $ = require('jquery'),
...
},{"./../util/formatter":24,"_process":5,"jquery":3}],19:[function(require,module,exports){
...
},{"./../util/formatter":24,"_process":5,"jquery":3}],21:[function(require,module,exports){
...
},{"./resource":20}],22:[function(require,module,exports){
let Game = require('./game/core');

},{"./game/core":17}],23:[function(require,module,exports){
...
},{"favico.js":2}],24:[function(require,module,exports){
...
},{"swarm-numberformat":12}],25:[function(require,module,exports){
const $ = require('jquery'),
...
},{"jquery":3,"moment":4,"typed.js":16}]},{},[22]);
